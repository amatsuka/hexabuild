...
**Шаг 5 — публикация — делается только по отдельной команде человека.** Решение человека
09.09.2026: сама по себе, в конце стадии или захода, сборка в `gh-pages` не уезжает. Шаги 1–4
(собрать и посмотреть локально) свободны и ничего наружу не выносят; шаг 5 без прямой просьбы
не выполнять.
