...
namespace Game.Tutorial
{
    ...
    public sealed class TutorialView : MonoBehaviour
    {
        ...
        static string TextOf(TutorialStep step) => step switch
        {
            ...
            TutorialStep.Wall =>
                "Впереди вода и горы. Ни то ни другое не открыть:\nстены в этой игре обходят",
            TutorialStep.Bypass =>
                "Обход слева, двумя плитками: вдоль воды и сквозь гряду.\nОткрывай их и веди дорогу",
            TutorialStep.Bridge =>
                "За грядой река, и через неё есть брод.\nМост стоит 2 щебня и 2 доски: открой плитку и тапни ещё раз",
