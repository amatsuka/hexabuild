...
{
    /// <summary>
    /// Лента русла по маске направлений: полоса идёт через центр плитки к серединам граней,
    ...
    public static class RiverMeshBuilder
    {
        ...
        static Mesh Build(int linkMask, float width)
        {
            ...
            // Каждая пара направлений — свой сквозной проток. Опорная точка в центре превращает
            ...
            var mesh = new Mesh { name = $"River {linkMask:X2}" };
