namespace Game.Core
{
    ...
    public static class SessionSeed
    {
        ...
        /// сцену, а сцена по умолчанию поднимает главное меню, а не партию. Сид в этих случаях
        /// уже выбран — спрашивать его снова через меню незачем, флаг говорит `MainMenuView`
        /// пропустить себя и сразу включить `GameSession`. Читается один раз и сам гасится.
        /// </summary>
